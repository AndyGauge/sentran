...
class AttributesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post attributes_url, params: { attribute: { attribute: @attribute.attribute, eav_id: @attribute.eav_id, eav_type: @attribute.eav_type, value: @attribute.value } }
    end
  ...
  test "should update attribute" do
    patch attribute_url(@attribute), params: { attribute: { attribute: @attribute.attribute, eav_id: @attribute.eav_id, eav_type: @attribute.eav_type, value: @attribute.value } }
